...
public class Email {
    public static void enviarConGMail(String destinatario, String asunto, String cuerpo) {
        ...
        String remitente = "NOMBRECORREO";  //Para la dirección nomcuenta@gmail.com
        ...
        props.put(
                "mail.smtp.clave", "CONTRASENA");    //La clave de la cuenta
        props.put(
...
//            message.setText(cuerpo);
            ...
            transport.connect("smtp.gmail.com", remitente, "ProtectionBank");
            transport.sendMessage(message, message.getAllRecipients());
            transport.close();
        } catch (MessagingException me) {
            me.printStackTrace();   //Si se produce un error
            IO.mostrar("ERROR AL MANDAR EL CORREO");
        }
    }
}
